...
public class SubtractionTest extends Assert {
    ...
    public void subThree() {
        ...
        assertEquals("Операция вычитания 3 минус 3 не верная. Актуальный результат = ",
                0, result, 0);
    }
    ...
    public void subZero() {
        ...
        assertEquals("Операция вычитания 0 минус 0 не верная. Актуальный результат = ",
                0, result, 0);
    }
    ...
    public void subMinus() {
        ...
        assertEquals("Операция вычитания 1 минус -2 не верная. Актуальный результат = ",
                3, result, 0);
    }
}