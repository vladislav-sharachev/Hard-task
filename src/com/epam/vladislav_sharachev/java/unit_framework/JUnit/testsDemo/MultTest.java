...
public class MultTest { //умножение
  ...
  public void multByOneTest() {
      ...
      Assert.assertTrue("Операция умножения 3 на 1 не верная. Актуальный результат = " + result, 3 == result);
  }

  @Test
    public void multByZero() {
      double result = calc.mult(3, 0);
      Assert.assertEquals("Операция умножения 3 на 0 не верная. Актуальный результат = " + result, 0, result, 0);
