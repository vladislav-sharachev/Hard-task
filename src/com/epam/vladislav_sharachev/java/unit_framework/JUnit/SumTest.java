...
public class SumTest extends Assert {
    ...
    public void sumThree() {
        ...
        assertEquals("Операция сложения 3 плюс 3 не верная. Актуальный результат = ", 6, result, 0);
    }
    ...
    public void sumZero() {
        ...
        assertEquals("Операция сложения 0 плюс 0 не верная. Актуальный результат = ", 0, result, 0);
    }
    ...
    public void sumMinus() {
        ...
        assertEquals("Операция сложения -1 плюс -1 не верная. Актуальный результат = ", -2, result, 0);
    }
}