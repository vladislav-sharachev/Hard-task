...
public class MultiplicationTest extends Assert {
    ...
    public void multThree() {
        ...
        assertEquals("Операция умножения 3 на 3 не верная. Актуальный результат = ", 9, result, 0);
    ...
    public void multZero() {
        ...
        assertEquals("Операция умножения 3 на 0 не верная. Актуальный результат = ", 0, result, 0);
    ...
    public void multNegative() {
        ...
        assertEquals("Операция умножения 3 на -1 не верная. Актуальный результат = ", -3, result, 0);
